...
SELECT name, CASE WHEN teacher.dept IN (1,2) THEN 'Sci' ELSE 'Art' END
FROM teacher
...
-- #'None' otherwise.
SELECT name, CASE WHEN teacher.dept IN (1,2) THEN 'Sci' WHEN teacher.dept = 3 Then 'Art' ELSE 'None' END
FROM teacher